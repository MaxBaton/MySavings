...
abstract class SwipeHelper(private val recyclerView: RecyclerView): ItemTouchHelper.SimpleCallback(
    ...
    override fun onChildDraw(
        ...
        if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
            if (dX < 0) {
                ...
                buttons.forEach { it.intrinsicWidth = it.sizes.first.toFloat() }
    ...
    class UnderlayButton(
        ...
        private var temp: Bitmap
        private var bitmap: Bitmap? = null
        val sizes = 175 to 175
        ...
        init {
            ...
            temp = BitmapFactory.decodeResource(context.resources, icon)
        }
        ...
        fun draw(canvas: Canvas, rect: RectF) {
            ...
            if (w > 0 && h > 0) {
                bitmap = Bitmap.createScaledBitmap(temp, w, h, true)
            }
            if (bitmap != null) {
